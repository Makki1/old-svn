...
MM:
avr-gcc -mmcu=attiny25 -O2 -c ow_slave_DS18B20.c
avr-objcopy -O ihex  ow_slave_DS18B20.o ow_slave_DS18B20_tiny25.hex
avrdude -c stk500 -P /dev/ttyUSB0 -p attiny25 -U flash:w:ow_slave_DS18B20_tiny25.hex 
*/
