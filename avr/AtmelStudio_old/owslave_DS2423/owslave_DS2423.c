...
MM:
avr-gcc -mmcu=attiny2313 -O2 -c ow_slave_DS2423.c
avr-objcopy -O ihex  ow_slave_DS2423.o ow_slave_DS2423_tiny2313.hex
avr-gcc -mmcu=attiny25 -O2 -c ow_slave_DS2423.c
avr-objcopy -O ihex  ow_slave_DS2423.o ow_slave_DS2423_tiny25.hex
avrdude -c stk500 -P /dev/ttyUSB0 -p attiny2313 -U flash:w:ow_slave_DS2423_tiny2313.hex
avrdude -c stk500 -P /dev/ttyUSB0 -p attiny25 -U flash:w:ow_slave_DS2423_tiny25.hex
