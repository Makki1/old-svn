...
typedef enum {
  ...
  */
  ...
  PID_MANUFACTURER_PIXELS = 0x8101,
  PID_MANUFACTURER_GRID_X = 0x8102,
  PID_MANUFACTURER_GRID_Y = 0x8103,
} rdm_pid;

/* Supported RDM PIDs - only the ones not REQUIRED! */
const unsigned int RDM_SUPPORTED_PIDS[] = { 
//  PID_QUEUED_MESSAGE, 
//  PID_STATUS_MESSAGES, 
...
// PID_RESET_DEVICE,
  ...
  PID_MANUFACTURER_PIXELS,
//  PID_MANUFACTURER_GRID_X,
//  PID_MANUFACTURER_GRID_Y,
// TODO: wanted specials: SW-Version, MCU used, Timeout-EOM, packets OK, Uptime? etc.
// TODO: Preset store/Playback (Demo-loops?)
};
