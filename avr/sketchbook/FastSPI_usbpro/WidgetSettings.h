...
class WidgetSettingsClass {
  public:
    ...
    unsigned int DevicePowerCycles() const;
    void SetDevicePowerCycles(unsigned int count);
  ...
  private:
    ...
    unsigned long ReadLong(unsigned int offset) const;
    void WriteLong(unsigned int offset, long data);
};
