...
void RDMHandler::HandleRDMMessage(const byte *message, int size) {
  ...
  LSL("RDM: ESTA") LVH(expected_esta_id) LVH(message + 3) LVH(message + 4)
  LSL("RDM: Serial") LVH(message + 5) LVH(message + 6) LVH(message + 7) LVH(message + 8) 

  if (!to_us) {
    LSL("RDM_INVALID_DEST")
